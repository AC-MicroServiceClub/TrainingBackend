...
CREATE TABLE IF NOT EXISTS `training`.`training_plan` (
  ...
  `STATE_IND` char(1) NOT NULL DEFAULT '0' COMMENT'0-PLANNED 1-IN-PROGRESS 2-CANCELLED 3-COMPLETED',  
  PRIMARY KEY (`ID`));
...
CREATE TABLE `training`.`training` (
  ...
  `TRAINING_MATERIAL` text NULL,
  `TRAINING_VIDEO` text NULL,
  `CREATOR_ID` int(11) NOT NULL DEFAULT '0',
  `CREATOR` varchar(45) NOT NULL DEFAULT '',
  `CREATE_DATE` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UPDATED_BY_ID` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `training`.`training_plan`
(`ID`,
`TRAINING_PLAN_ID`,
`TRAINING_PLAN_NAME`,
`TRAINING_PLAN_START_TIME`,
`TRAINING_PLAN_END_TIME`,
`CREATOR_ID`,
`CREATOR`,
`CREATE_DATE`)
VALUES
...
1,
'PPT Sharing',
'2018-07-03 12:00:00.000',
'2018-07-03 14:00:00.000',
120,
'24#9T001',
'PPT Sharing',
'1:xiaohui.c.liu',
...
'Year2018TrainingPlan',
1,
'基于Excel & Macro的数据比对技能培训',
'2018-07-01 10:00:00.000',
'2018-07-01 11:00:00.000',
120,
'online',
'基于Excel & Macro的数据比对技能培训',
'1:xiaohui.c.liu|2:fangzhou.li',
2,
'fangzhou.li',
CURRENT_TIMESTAMP);
